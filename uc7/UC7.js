...
function addContact(contact) {
    let isDuplicate = addressBook.some(existingContact => 
...
try {
    ...
    let duplicateContact = new Contact("John", "Doe", "789 Oak St", "Delhi", "Delhi", "110001", "9112233445", "john.doe@newmail.com");

    addContact(contact1); // Adds successfully
    addContact(contact2); // Adds successfully
    addContact(duplicateContact); //error message

    console.log("Final Address Book:", addressBook);
