...
function deleteContact(name) {
    let index = addressBook.findIndex(contact => contact.firstName === name || contact.lastName === name);
    ...
    let removedContact = addressBook.splice(index, 1);
    console.log(`Deleted Contact: ${removedContact[0].toString()}`);
}
